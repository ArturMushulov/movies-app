...
<template>
  <div class="movie-info-wrap">
    <header class="movie-info-header">
        ...
        <b-iconX class="close-icon" @click="closeModal"></b-iconX>
    </header>
    <div class="movie-info-content">
        <b-row>
            ...
            <b-col sm="8">
                ...
                <div class="mt-3 mb-4  badge-items">
                    <b-badge variant="light" class="mr-2">{{ movie.Year }} year</b-badge>
...
<style scoped>
    ...
    .movie-rating >>> .b-rating-star, .movie-rating >>> .b-rating-value {
